import colorama
#some ANSi sequences for the colours or effects
BLACK = '\u001b(30m'
RED = '\u001b(31m'
GREEN = '\u001b(32m'
YELLOW = '\u001b(33m'
...
# *effects here means : “Accept any number of extra arguments and pack them into a tuple.”
def colour_print(text:str, *effects:str)->None:
    ...
    :param str effects: the effect we want , one of the constants
                defined at the start of this module.
    """
    effect_string= "".join(effects)
    output_strings= "{0}{1}{2}".format(effect_string,text,RESET)
